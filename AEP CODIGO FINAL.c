...
// Função para criptografar a senha usando Cifra de Substituição, incluindo letras e números
...
// Função para descriptografar a senha usando Cifra de César, incluindo letras e números
...
int main() {
    ...
    int opcao;
    int id;
    int chaveCriptografia = 3;  /* Definindo uma chave para a Cifra de César (deslocamento de 3 caracteres) */
